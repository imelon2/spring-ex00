...
<body>
	...
	<div class="container">
		...
		<!-- 댓글 삭제 alert -->
		<div id="alert2" class="alert alert-primary fade" role="alert">
		</div>
		<h1>글 보기</h1>
			...
			<div class="modal-content">
				...
				<div class="modal-body">
					<form>
						...
						<div class="form-group">
							...
							<input class="form-control" id="reply-replyer-input1" value="${pinfo.member.userid }" type="hidden">
				...
				<div class="modal-footer">
					...
					<button type="button" class="btn btn-primary"
						id="reply-submit-btn1">댓글 입력</button>
				</div>
			</div>
		</div>
	</div>
	...
	<div class="modal fade" id="reply-modify-modal" tabindex="-1"
		...
		<div class="modal-dialog">
			<div class="modal-content">
				<div class="modal-header">
					<h5 class="modal-title">댓글수정/삭제</h5>
					<button type="button" class="close" data-dismiss="modal"
						aria-label="Close">
						<span aria-hidden="true">&times;</span>
					</button>
