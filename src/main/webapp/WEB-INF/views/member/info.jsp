...
<script>
	$(function() {
		$("#member-remove-btn1").click(function() {
		...
		<div class="row">
			<div class="col-12">
				<form id="member-info-form1" method="post" action="${appRoot }/member/modify">
					...
					<button type="submit" class="btn btn-secondary" id="member-modify-btn1" >정보 수정</button>
					<button type="button" class="btn btn-danger" id="member-remove-btn1" >회원 탈퇴</button>
				</form>
			</div>
		</div>
</div>
